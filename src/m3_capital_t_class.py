    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        v_rect_corner1 = rg.Point(intersection_center.x-letter_thickness/2 ,intersection_center.y+height-letter_thickness/2)
        v_rect_corner2 = rg.Point(intersection_center.x + letter_thickness / 2, intersection_center.y + letter_thickness / 2)
    ...
    def clone(self):
        ...
        height = self.v_rect.get_height() + self.h_rect.get_height()
        center = self.h_rect.get_center()
        thickness = self.h_rect.get_height()
        yeet = CapitalT(center, width, height, thickness)
        yeet.set_colors(self.v_rect.fill_color, self.v_rect.outline_color)
        return yeet
